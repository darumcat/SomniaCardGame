...
// Полный ABI для NFT контракта (из NFT.txt)
const NFT_ABI = [
	{
		"inputs": [
			{
...
// Полный ABI для USDCard контракта (из USDCard.txt)
const USDCARD_ABI = [
	{
		"inputs": [
			{
...
// Полный ABI для CardGame контракта (из CardGame.txt)
const CARDGAME_ABI = [
	{
		"inputs": [
			{
...
export default function App() {
  ...
  // ... остальные функции (mintNFT, mintUSDCard и т.д.)
}
